...
class DESTest(unittest.TestCase):
    ...
    def test_add_packet_to_buffer(self):
        ...
        self.assertEqual(
            [True, 1],
            [s.add_packet_to_buffer(), s.buffer_content],
    ...
    def test_start_service(self):
        ...
        self.assertEqual(
            False,
            s.server.start_service(pkt_arrived=True),
            msg="Error in Server. Should not be able to start service.",
        )

        s.server.server_busy = False
        self.assertEqual(
            [True, DESTest.sim.sim_param.S - 1],
    ...
    def test_packet_entered_dropped(self):
        ...
        self.assertEqual(
            [9, 4],
            [s.packets_total, s.packets_dropped],
    ...
    def test_generate_packet_arrival(self):
        ...
        for r in results:
            ...
            self.assertAlmostEqual(
                ...
                ue.last_iat,
                delta=1.0,
                msg="Error in User. Wrong sequence of inter-arrival times.",
            )
        self.assertEqual(
            5,
            len(DESTest.sim.event_chain.event_list),
    ...
    def test_packet_arrival(self):
        ...
        self.assertEqual(
            [0, False],
            [
                DESTest.sim.sys_state.buffer_content,
                DESTest.sim.sys_state.server.server_busy,
            ],
    ...
    def test_generate_service_completion(self):
        ...
        for _ in range(10):
            self.assertEqual(
                10,
                DESTest.sim.event_chain.remove_oldest_event().timestamp,
